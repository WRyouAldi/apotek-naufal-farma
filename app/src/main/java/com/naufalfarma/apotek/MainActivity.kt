    ...
    companion object {
        private val PERSISTENT_DB_JS = """
            (function(){
              ...
              function persistentSearch(){const list=nativeSearch();window.__naufalResults=list;renderResults(list);}
